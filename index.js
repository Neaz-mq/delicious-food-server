...
async function run() {
  try {
	...
	.create(process.env.MAIL_SENDING_DOMAIN, {
		from: "Mailgun Sandbox <postmaster@sandbox16836f5c569f4db6ab7b71cbe46f927a.mailgun.org>",
		to: ["neazmorshed666@gmail.com"],
		subject: "Food Buzz Order Confirmation",
...
app.get('/', (req, res) => {
  res.send('food is here')
})

app.listen(port, () => {
  console.log(`Delicious food is here on port ${port}`);
})
